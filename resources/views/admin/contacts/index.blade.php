...
@endsection
@section('page_name') Contacts @endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> Contacts {{($setting->title) ?? ''}}</h3>
                    <div class="">
        ...
        <div class="modal fade" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Contact data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        destroyScript('{{route('contacts.destroy', 'id')}}');
        // Add Using Ajax
        showEditModal('{{route('contacts.edit',':id')}}');
    </script>
@endsection
