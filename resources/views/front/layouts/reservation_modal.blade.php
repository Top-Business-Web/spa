            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="wsus__reservation_form" action="{{ route('reservationStore') }}" method="post">
                        @csrf
                        <input class="reservation_input" name="name" type="text" placeholder="{{trans('website.name')}}">
                        <input class="reservation_input" name="phone" type="text" placeholder="{{trans('website.phone')}}">
                        <input class="reservation_input" name="address" type="text" placeholder="{{trans('website.address')}}">
