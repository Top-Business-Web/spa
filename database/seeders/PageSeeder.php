    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'top_description_ar' => 'لابوريس برويدنت يو سينت أميت هو ممارسة حيوية باستثناء الهاربين من الصحراء. لا داعي للقلق بشأن العمل الذي تجلس فيه إلا في حالة الطوارئ. إن ممارسة التمارين الرياضية أمر لا يستحق اللوم.',
                'down_title' => 'spa down',
                ...
                'down_description_ar' => 'لابوريس برويدنت يو سينت أميت هو ممارسة حيوية باستثناء الهاربين من الصحراء. لا داعي للقلق بشأن العمل الذي تجلس فيه إلا في حالة الطوارئ. إن ممارسة التمارين الرياضية أمر لا يستحق اللوم.',
                'category_id' => '1',
            ],
            [
